...
begin
  ...
  prbs9_seek: process
    constant ctxt: log_context := "Seeking";
  ...
  begin
    ...
    loop
      ...
      assert_equal(ctxt, "fw/bw " & to_string(i),
  ...
  prbs9_test: process
    ...
    constant ctxt: log_context := "PRBS9";

  begin
    
    assert_equal(ctxt, "ours vs ref",
                 prbs9_ref,
  ...
  prbs_test: process
    ...
    constant ctxt: log_context := "PRBS15";
