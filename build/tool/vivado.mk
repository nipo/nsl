...
$(build-dir)/create.tcl: $(build-dir)/sources.tcl $(vivado-init-tcl)
	$(call file-clear,$@)
	$(call project_init,$@)
	$(call vivado-tcl-sources-append,$@,sources_1,constrs_1)
	$(call file-append,$@,save_project_as -force $(top) ../$(dir $@))

project/$(top).xpr:  $(MAKEFILE_LIST)
	$(call vivado-tcl-run,$@.tcl)

$(build-dir)/synth.dcp: $(sources) $(vivado-init-tcl) $(MAKEFILE_LIST)
	$(call file-clear,$@.tcl)
	$(call project_init,$@.tcl)
	$(call project_load_sources,$@.tcl)
