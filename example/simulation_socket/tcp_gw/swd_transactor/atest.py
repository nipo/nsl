from acrobe.protocol import datagram, swd
from acrobe.component.nsl.transactor.swd import SwdTransactor
...
from acrobe.cli.console import main
...
@datagram.Datagram.db.register("swdtb")
