...
# 50 MHz oscillator, CLOCK0_50 on a 1.1 V bank.  CLOCK1_50 on V16
# shares its path into the core with the header pin below, and both
# are clocks here.
set_location_assignment PIN_DJ35 -to clk50m_i
set_instance_assignment -name IO_STANDARD "1.1-V" -to clk50m_i
...
# GPIO0_D0 on the 2x20 header, left unconnected.
set_location_assignment PIN_H16 -to ddr_loop_io
set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to ddr_loop_io
