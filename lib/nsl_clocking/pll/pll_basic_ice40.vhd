...
begin
  ...
  with_pll: if input_hz_c /= output_hz_c
  generate
    ...
    constant divf_c : std_logic_vector := std_logic_vector(to_unsigned(params.divf, 7));
    constant divr_c : std_logic_vector := std_logic_vector(to_unsigned(params.divr, 4));
    constant divq_c : std_logic_vector := std_logic_vector(to_unsigned(params.divq, 3));
    constant filter_range_c : std_logic_vector := std_logic_vector(to_unsigned(params.filter_range, 3));
  begin
